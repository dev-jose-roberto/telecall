...
e = this, t = function(e) {
    ...
    function F() {
        ...
        var e = function(t) {
                for (var c = Array.from(u.scripts).filter(function(e) { return !e.hasAttribute(x) && e !== t }), a = {}, e = function(e) {
                        ...
                        }.toString(), ")('").concat(b, "', '").concat(o, "', '").concat(i, "');"), t.onload = function() { t.contentWindow.addEventListener("error", D, !0), t.contentDocument.head.appendChild(r), t.contentDocument.head.appendChild(n) }, m(function() { return u.body.appendChild(t) })
            ...
            o = function() {
                ...
                function n(e, t) {
                    ...
                    }.toString(), ")('").concat(b, "', '").concat(o || "foo", "', '").concat(t, "', '").concat(c, "');"), n.onload = function() { n.contentWindow.addEventListener("error", D, !0), n.contentDocument.head.appendChild(i), n.contentDocument.head.appendChild(e), n.contentDocument.body.appendChild(r) }, m(function() { return u.body.appendChild(n) })
                }
    ...
    var O = l.FontAwesomeDetection || {},
        ...
        }, O, { __pollUntil: E, md5ForNode: v, detectionDone: !1, nodesTested: null, nodesFound: null });
    l.FontAwesomeDetection = N;
    var j = function() { try { return "production" === process.env.NODE_ENV } catch (e) { return !1 } }();
    ! function(e) { try { e() } catch (e) { if (!j) throw e } }(function() { c && s && F(window.FontAwesomeDetection.report) }), e.conflictDetection = F, Object.defineProperty(e, "__esModule", { value: !0 })
