...
e = function() {
    ...
    function t(t, e) { var n, o = Object.keys(t); return Object.getOwnPropertySymbols && (n = Object.getOwnPropertySymbols(t), e && (n = n.filter(function(e) { return Object.getOwnPropertyDescriptor(t, e).enumerable })), o.push.apply(o, n)), o }
    ...
    function c(o) {
        for (var e = 1; e < arguments.length; e++) {
            ...
            e % 2 ? t(Object(r), !0).forEach(function(e) {
                var t, n;
                t = o, e = r[n = e], n in t ? Object.defineProperty(t, n, { value: e, enumerable: !0, configurable: !0, writable: !0 }) : t[n] = e
    ...
    var e = {},
        r = {};
    try { "undefined" != typeof window && (e = window), "undefined" != typeof document && (r = document) } catch (e) {}

    function i() { u.removeEventListener("DOMContentLoaded", i), p = 1, m.map(function(e) { return e() }) }
    ...
    function g(e) { d && (p ? setTimeout(e, 0) : m.push(e)) }
    ...
    var y = (function(e) {
        ...
        function a(e, t, n, o, r, i) { return u((i = u(u(t, e), u(o, i))) << r | i >>> 32 - r, n) }

        function d(e, t, n, o, r, i, c) { return a(t & n | ~t & o, e, t, r, i, c) }

        function m(e, t, n, o, r, i, c) { return a(t & o | n & ~o, e, t, r, i, c) }

        function p(e, t, n, o, r, i, c) { return a(t ^ n ^ o, e, t, r, i, c) }
        ...
        function s(e) { for (var t = "", n = 32 * e.length, o = 0; o < n; o += 8) t += String.fromCharCode(e[o >> 5] >>> o % 32 & 255); return t }

        function l(e) { var t = []; for (t[(e.length >> 2) - 1] = void 0, o = 0; o < t.length; o += 1) t[o] = 0; for (var n = 8 * e.length, o = 0; o < n; o += 8) t[o >> 5] |= (255 & e.charCodeAt(o / 8)) << o % 32; return t }
        ...
        function r(e) { return s(c(l(e = n(e)), 8 * e.length)) }
    ...
    function b(e) { if (null !== e && "object" === n(e)) return e.src ? y(e.src) : e.href ? y(e.href) : e.innerText && "" !== e.innerText ? y(e.innerText) : void 0 }
    var v = "fa-kits-diag",
        ...
        E = function(e) { e.preventDefault(), e.stopPropagation() };

    function O(e) {
        var t = e.fn,
            i = void 0 === t ? function() { return !0 } : t,
            t = e.initialDuration,
            n = void 0 === t ? 1 : t,
            t = e.maxDuration,
    ...
    function C(t) {
        for (var i = Array.from(u.scripts).filter(function(e) { return !e.hasAttribute(x) && e !== t }), c = {}, e = 0; e < i.length; e++) ! function(e) {
            ...
            r.innerText = "(".concat(function(n, o, r) {
                parent.FontAwesomeDetection.__pollUntil({ fn: function() { return !!window.FontAwesomeConfig || !!window.FontAwesomeKitConfig } }).then(function() {
            ...
            }.toString(), ")('").concat(w, "', '").concat(o, "', '").concat(e, "');"), t.onload = function() { t.contentWindow.addEventListener("error", E, !0), t.contentDocument.head.appendChild(r), t.contentDocument.head.appendChild(n) }, g(function() { return u.body.appendChild(t) })
        }(e);
        return c
    }
    ...
    function j(e) {
        ...
        f.onmessage = function(e) { "file://" !== f.location.origin && e.origin !== f.location.origin || e && e.data && ("fontawesome-conflict" === e.data.type ? n.conflict[e.data.md5] = e.data : "no-conflict" === e.data.type && (n.noConflict[e.data.md5] = e.data)) };
        var o = C(u.currentScript),
            e = function() {
                var e = Array.from(u.getElementsByTagName("link")).filter(function(e) { return !e.hasAttribute(x) }),
                    t = Array.from(u.getElementsByTagName("style")).filter(function(e) { return !e.hasAttribute(x) && (!f.FontAwesomeConfig || !e.innerText.match(new RegExp("svg:not\\(:root\\)\\.".concat(f.FontAwesomeConfig.replacementClass)))) });
                ...
                function n(e, t) {
                    ...
                    i.innerText = "(".concat(function(n, t, o, r) {
                        parent.FontAwesomeDetection.__pollUntil({
                            ...
                            var e = document.getElementById(n);
                            parent.postMessage({ type: "fontawesome-conflict", technology: "webfont", href: e.href, innerText: e.innerText, tagName: e.tagName, md5: o }, r)
                        }).catch(function(e) { var t = document.getElementById(n); "timeout" === e ? parent.postMessage({ type: "no-conflict", technology: "webfont", href: t.src, innerText: t.innerText, tagName: t.tagName, md5: o }, r) : console.error(e) })
                    }.toString(), ")('").concat(w, "', '").concat(o || "foo", "', '").concat(t, "', '").concat(c, "');"), n.onload = function() { n.contentWindow.addEventListener("error", E, !0), n.contentDocument.head.appendChild(i), n.contentDocument.head.appendChild(e), n.contentDocument.body.appendChild(r) }, g(function() { return u.body.appendChild(n) })
                }
    ...
    var S = f.FontAwesomeDetection || {},
        N = c(c(c({}, {
            report: function(e) {
                ...
                if (0 < (e = Object.keys(n.conflict).length)) {
                    ...
                    for (i in n.conflict) {
                        var a = n.conflict[i];
                        c[i] = { tagName: a.tagName, "src/href": a.src || a.href || "n/a", "innerText excerpt": a.innerText && "" !== a.innerText ? a.innerText.slice(0, 200) + "..." : "(empty)" }
                    }
                    console.table(c)
                }
                if (0 < (e = Object.keys(n.noConflict).length)) {
                    ...
                    for (s in n.noConflict) {
                        ...
                        l[s] = { tagName: f.tagName, "src/href": f.src || f.href || "n/a", "innerText excerpt": f.innerText && "" !== f.innerText ? f.innerText.slice(0, 200) + "..." : "(empty)" }
                    }
                    console.table(l)
                }
        ...
        }), S), {}, { __pollUntil: O, md5ForNode: b, detectionDone: !1, nodesTested: null, nodesFound: null });
    f.FontAwesomeDetection = N;
    var k = function() { try { return "production" === process.env.NODE_ENV } catch (e) { return !1 } }(),
